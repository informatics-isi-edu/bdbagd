...
**Content:**
```
http://localhost:8080/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc/genotypes.csv
http://localhost:8080/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc/phenotypes.csv
```
...
```javascript
$.ajax({
    url: "/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc/genotypes.csv",
    type : "GET",
    success : function(r) {
      console.log(r);
    }
...
```javascript
$.ajax({
    url: "/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc/log",
    type : "GET",
    success : function(r) {
      console.log(r);
    }
...
**Content:**
```
http://localhost:8080/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc/sample-bag.zip
```
...
```javascript
$.ajax({
    url: "/iobox/export/file/9ad15e5b-9c2c-4faf-8829-05fa8252c8bc",
    type : "GET",
    success : function(r) {
      console.log(r);
    }
